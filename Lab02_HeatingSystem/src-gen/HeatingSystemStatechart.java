...
public class HeatingSystemStatechart implements IStatemachine, ITimed {
	public enum State {
		MAIN_REGION_ON,
		MAIN_REGION_OFF,
		MAIN_REGION_ONTIMER,
	...
	public HeatingSystemStatechart() {
		for (int i = 0; i < 1; i++) {
	...
	*/
	...
	private void runCycle() {
		...
		do { 
			...
			clearInEvents();
			nextEvent();
		} while (((((operate || timer) || timerOn) || timerOff) || timeEvents[0]));
